...
// - Return the pointer.
bool RoutePlanner::compare(const RouteModel::Node *_first_node,const RouteModel::Node *_second_node){
    float first_node_value = _first_node->h_value + -_first_node->g_value;
    float second_node_value = _second_node->h_value + -_second_node->g_value;
